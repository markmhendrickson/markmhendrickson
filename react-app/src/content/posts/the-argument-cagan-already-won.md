---
title: "The argument Marty Cagan already won, then abandoned"
excerpt: "On the PM role, AI, and the strange decision to define your job around the skill that just got commoditized."
published: true
...
Which is why it matters that his most recent work contains a contradiction sharp enough to see from orbit.

In December 2023, Cagan published ["The Product Manager Contribution"](https://www.svpg.com/the-product-manager-contribution), where he defined four critical knowledge domains the PM must bring to the team: deep knowledge of customers, fluency with data and analytics, a thorough understanding of the business (go-to-market, stakeholders, economics, compliance), and command of the competitive landscape and industry trends. His conclusion was unambiguous:
...
>
> *Marty Cagan, ["Product vs. Feature Teams"](https://www.svpg.com/product-vs-feature-teams), October 2023*
...
>
> *Marty Cagan, ["Two in a Box PM"](https://www.svpg.com/two-in-a-box-pm), January 2022*

That isn't prototyping. That's relationship-building, organizational embeddedness, and the slow accumulation of trust across every function of the business. You can't test for viability by showing a stakeholder a Lovable prototype. You test for viability by having a relationship deep enough that the stakeholder tells you the real constraints, not the official ones.
...
Those are integration failures, not prototyping failures. They are cross-disciplinary tensions that live in the relationships *between* the dimensions, not in any single one. No number of Lovable prototypes will surface them.
...
AI prototyping tools are precisely what cures that pathology. When any PM can spin up a working prototype in an afternoon, the barrier that was keeping them trapped in coordination work is gone. The coordinator PM can now touch the product. The spec-writer can now prototype instead of describe.
...
None of this means Cagan is wrong about everything. The distinction between [build to learn and build to earn](https://www.svpg.com/build-to-learn-vs-build-to-earn/) is real and useful. The [four-risk framework](https://www.svpg.com/four-big-risks/) is a good starting checklist. The warning about PMs who [confuse prototypes with products](https://www.svpg.com/prototypes-vs-products/) is timely. And the call for PMs to actually engage with the product, to build, not just describe, has always been one of his most valuable contributions.

But the direction of the recent work, from PM-as-integrator toward PM-as-prototyper, from the role being "more essential" to the role being "one possible instantiation of product creator," is a retreat from his strongest ground. It defines the job around the activity that AI just made easy, while abandoning the activities that AI can't touch and that the earlier Cagan correctly identified as the PM's irreducible contribution.
...
Instead, we got: everyone is a builder now. Which is true. But it's the less interesting truth, and it leaves the harder question, who holds the full picture when everyone is building, unanswered.
