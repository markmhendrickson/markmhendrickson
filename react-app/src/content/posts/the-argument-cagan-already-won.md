---
title: "When building got easy, the PM job got harder to explain"
...
The PM who holds all four of those knowledge domains in their head, and uses that integrated understanding to make judgment calls that no specialist can make from their vantage point alone, is the scarcest input in an AI-accelerated product organization. Not because they can prototype faster than the engineer, but because they know which prototype to build, what signal to extract from it, and how to integrate that signal with everything else they know about the business, the customer, and the market.
...
## The question every role is asking
