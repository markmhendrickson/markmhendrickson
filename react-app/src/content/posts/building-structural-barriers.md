...
I'm building [Neotoma](/posts/truth-layer-agent-memory) ([GitHub](https://github.com/markmhendrickson/neotoma)) as a privacy-first, deterministic memory substrate for AI tools. [The agentic trends I'm betting on](/posts/six-agentic-trends-betting-on) are what make this space worth building in; this post is about why that bet is structurally defensible. Neotoma demonstrates all five barriers.
